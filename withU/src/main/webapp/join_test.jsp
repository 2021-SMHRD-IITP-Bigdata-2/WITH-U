	...
	<div class="join">
		...
		<form action="JoinCon" method="post">
			<div class="inputForm">
				...
				<input type="text" class="tel" name="tel" placeholder="전화번호">
				<button type="submit" class="joinBtn"> <a class= "joinHref1"  href="Main.jsp"> 가입 </a> </button>
			</div>
		</form>
		<table class="joinTable">
			<tr>
				<td>
					<div class="joinLog">
						<p class="joinQ">
							계정이 있으신가요? <a class="joinHref2" href="Login.jsp" tabindex="0">
