...
<body>
    ...
    <div class="main-container">
        <header id="my_header">
            ...
            <nav id="header-menu">
                <ul >
                    <li class="nav-item"><a href="#profile-post" data-toggle="tab" id="nonsee">글 보기</a></li>
                    <li class="nav-item"><a href="#" data-toggle="tab" id="see">자가진단 결과</a></li>
                    <li class="nav-item"><a href="#" data-toggle="tab" id="nonsee">필수템 찜 목록</a></li>
                </ul>
            </nav>
        </header>
        <div class="testResult">
            <table frame=void>
                <tr>
                    <td colspan="3"><h2>닉네임 님의 우울증 자가진단 검사 결과는 ?</h2></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3">
                        <span id="comment">
                            우울증 자가진단 검사의 결과 점수가 높을수록<br>
                            우울증을 느끼는 정도가 심하다는 의미예요.<br>
                            우울감이 지속되고, 나아지지 않는다면 지역 상담사를 통해 상담을 받아보는 것도 좋은 방법이랍니다.
                    </td>
                </tr>
            </table>
        </div>
